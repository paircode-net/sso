...
{
	public sealed class CreateRoleSpecificationsValidator : DomainValidator<Role>
	{
		public CreateRoleSpecificationsValidator(RoleCodeAlreadyExistsSpecification spec)
		{
