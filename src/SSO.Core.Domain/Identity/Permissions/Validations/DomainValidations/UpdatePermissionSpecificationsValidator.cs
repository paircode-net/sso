...
{
	public sealed class UpdatePermissionSpecificationsValidator : DomainValidator<Permission>
	{
		public UpdatePermissionSpecificationsValidator(PermissionCodeAlreadyExistsSpecification spec)
		{
