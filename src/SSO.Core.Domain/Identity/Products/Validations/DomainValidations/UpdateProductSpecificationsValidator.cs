...
{
	public sealed class UpdateProductSpecificationsValidator : DomainValidator<Product>
	{
		public UpdateProductSpecificationsValidator(ProductCodeAlreadyExistsSpecification spec)
		{
